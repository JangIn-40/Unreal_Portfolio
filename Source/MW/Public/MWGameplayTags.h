...
namespace MWGameplayTags
{
	...
	MW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Ability_SpawnDamageZone);
	...
	MW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Ability_Stun);
	...
	MW_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_SetByCaller_DotDamage);
